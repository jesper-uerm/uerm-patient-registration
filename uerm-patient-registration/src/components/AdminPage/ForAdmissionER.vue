    ...
    <q-card class="no-shadow" style="border: 1px solid #e0e0e0; border-radius: 8px">
          ...
          <!-- <template v-slot:body-cell-actions="props">
            <q-td :props="props" class="text-center q-py-xs">
              <q-btn
                ...
                color="green-8"
                icon="note_add"
                label="Create Case Number"
                size="sm"
                class="q-my-xs text-caption"
                @click="openCaseNumberDialog(props.row)"
              />
            </q-td>
          </template> -->
      ...
      >
        <q-card class="column full-height">
          ...
          <q-card-section class="col scroll q-px-xl">
            <q-form ref="casenumberForm" @submit="handleCaseNumber" class="q-pa-sm">
              <div
                class="text-caption2 q-py-sm bg-grey-4 text-center text-uppercase q-mb-sm"
              >
                Patient Information:
              </div>
              ...
              <div class="row q-col-gutter-xs q-mb-sm">
                <div class="col-12 col-sm-4 col-md-4 text-weight-medium text-uppercase">
                  <q-checkbox
                    v-model="formData.caseOrSched"
                    label="For OR Scheduled"
                    true-value="1"
                    false-value="0"
                  />
                </div>
                <div
                  class="col-12 col-sm-4 col-md-4 q-mb-sm text-weight-medium text-uppercase"
                >
                  <q-checkbox
                    v-model="formData.caseDependent"
                ...
                <div class="col-12 col-sm-4 col-md-4 text-weight-medium text-uppercase">
                  <q-checkbox
                    v-model="formData.caseTransfer"
                    label="From other Hospital/Center"
                    true-value="1"
                    false-value="0"
                  />
                </div>
              </div>
              <div class="row q-col-gutter-xs" v-if="formData.caseTransfer === '1'">
                <div class="col-12 col-sm-6 col-md-6">
                  <q-input
                    outlined
                    dense
                    v-model="formData.caseTransferFrom"
                    label-slot
                    :rules="[(val) => !!val || 'Required']"
                  >
                    <template v-slot:label>
                      From Other Hospital: <span class="text-red">*</span>
                    </template>
                  </q-input>
                </div>
                <div class="col-12 col-sm-6 col-md-6">
                  <q-input
                    outlined
                    dense
                    v-model="formData.caseModeTransfer"
              ...
              <div class="row q-col-gutter-md">
                ...
                <div class="col-12 col-sm-3 col-md-3">
                  <q-select
                    outlined
                    dense
                    v-model="formData.casepatientCat"
                    :options="[
                  ...
                  >
                    <template v-slot:label>
                      Patient Category <span class="text-red">*</span>
                    </template>
                  </q-select>
                </div>
                <div class="col-12 col-sm-3 col-md-3">
              ...
              <div class="row q-col-gutter-md">
                ...
                <div class="col-12 col-sm-3 col-md-3">
                  <q-select
                    outlined
                    dense
                    v-model="formData.casefromER"
                    :options="[
                      { label: 'DIRECT ADMISSION', value: 'DIA' },
                      { label: 'DIRECT TO DR', value: 'DDR' },
                      { label: 'DIRECT TO OR', value: 'DOR' },
                      { label: 'ELECTIVE', value: 'ELE' },
                      { label: 'FROM ER', value: 'FER' },
                      { label: 'OPD', value: 'OPD' },
                    ]"
                    option-label="label"
                    option-value="value"
              ...
              <div class="row q-col-gutter-md">
                <div class="col-12 col-sm-6 col-md-6">
                  <q-input
                    outlined
                    dense
                    v-model="formData.casepdfRemarks"
                    label-slot
                    :rules="[(val) => !!val || 'Required']"
                  >
                    <template v-slot:label>
              ...
              <div class="row q-col-gutter-md">
                ...
                <div class="col-12 col-sm-4 col-md-4">
                  <q-input
                    outlined
                    dense
                    v-model="formData.caseAllergies"
                    label="Allergies"
                  />
                </div>
                <div class="col-12 col-sm-4 col-md-4">
                  <q-input
                    outlined
                    dense
                    v-model="formData.caseAdmittedBy"
                    label="Admitted By"
                  />
                </div>
              </div>
              ...
              <div
                class="text-caption2 q-py-sm bg-grey-4 text-center text-uppercase q-mb-md"
              >
                Infirmary:
              </div>
              ...
              <div class="row q-col-gutter-md">
                ...
                <div class="col-12 col-sm-6 col-md-6">
                  <q-select
                    outlined
                    dense
                    v-model="formData.caseDepartment"
                    :options="department || []"
                    emit-value
                    map-options
                    label="Department"
              ...
              <div class="row q-col-gutter-md">
                <div class="col-12 col-sm-4 col-md-4">
                  <q-input outlined dense v-model="formData.caseCompany" label="Company">
                  </q-input>
                </div>
                <div class="col-12 col-sm-4 col-md-4">
                  <q-input outlined dense v-model="formData.caseHmo" label="HMO">
                  </q-input>
                </div>
                <div class="col-12 col-sm-4 col-md-4">
                  <q-input
                    outlined
                    dense
                    v-model="formData.caseEmployer"
                    label-slot
                    :rules="[(val) => !formData.caseCompany || !!val || 'Required']"
                  >
                    <template v-slot:label>
                      Employer <span class="text-red" v-if="formData.caseCompany">*</span>
                    </template>
                  </q-input>
                </div>
              </div>
              ...
              <div class="row q-col-gutter-md">
                <div class="col-12 col-sm-4 col-md-4">
                  <q-input
                    outlined
                    dense
                    v-model="formData.caseCardNo"
                    label-slot
                    :rules="[(val) => !formData.caseHmo || !!val || 'Required']"
                  >
                    <template v-slot:label>
                      Card No <span class="text-red" v-if="formData.caseHmo">*</span>
                    </template>
                  </q-input>
                </div>
                <div class="col-12 col-sm-4 col-md-4">
                  <q-input
                    outlined
                    dense
                    v-model="formData.casecovAmount"
                    label-slot
                    :rules="[(val) => !formData.caseHmo || !!val || 'Required']"
                  >
                    <template v-slot:label>
                      Coverage Amount
                      <span class="text-red" v-if="formData.caseHmo">*</span>
                    </template>
                  </q-input>
                </div>
                <div class="col-12 col-sm-4 col-md-4">
              ...
              <div class="row q-col-gutter-md">
                ...
                <div class="col-12 col-sm-6 col-md-6">
                  <q-input
                    outlined
                    dense
                    v-model="formData.casermPlan"
                    label="Room Plan"
                  />
                </div>
                <div class="col-12 col-sm-6 col-md-6">
                  <q-input outlined dense v-model="formData.caseLoa" label="LOA No" />
                </div>
                <div class="col-12 col-sm-6 col-md-6">
                  <q-input
                    outlined
                    dense
                    v-model="formData.caseApprov"
                    label="Approval No"
                  />
                </div>
              </div>
              ...
              <div class="row q-col-gutter-md">
                <div class="col-12 col-sm-4 col-md-4">
                  <q-input
                    outlined
                    dense
                    v-model="formData.caseInformantName"
                    label-slot
                    :rules="[(val) => !!val || 'Required']"
                  >
                    <template v-slot:label>
                ...
                <div class="col-12 col-sm-4 col-md-4">
                  <q-input
                    outlined
                    dense
                    v-model="formData.caseInfAddress"
                    label-slot
                    :rules="[(val) => !!val || 'Required']"
                  >
                    <template v-slot:label>
...
export default defineComponent({
  ...
  methods: {
    ...
    openCaseNumberDialog(row) {
      this.resetForm();
      this.formData.patientId = row.PATIENTREGID;
